...
- Inertia: body inertia operator $\mathbb{I} : \mathfrak{g}  \mapto \mathfrak{g}^\star$ and $g$-dependent inertia $\mathbb{I}_g = \mathrm{Ad}_{g^{-1}}^\star \mathbb{I} \mathrm{Ad}_g$.
